...
(function () {
  ...
  function nav() {
    ...
    if (document.body.getAttribute("data-section") === "studio") {
      var sdrawer = '<a href="/studio#features">Features</a><a href="/studio#pricing">Pricing</a><a href="/studio#download">Get access</a><a class="login" data-auth-login href="/login">Sign in</a><a href="/">⌂ Home · Modulus Technologies</a>';
      return '<header class="nav"><div class="wrap nav-inner">' +
          ...
          '<nav class="nav-links" aria-label="Modulus Studio">' +
            '<a href="/studio#features">Features</a><a href="/studio#pricing">Pricing</a>' +
          '</nav>' +
          '<div class="nav-right">' +
      ...
      return '<footer class="footer"><div class="wrap">' +
          '<div class="footer-top">' +
            ...
            '<div class="footer-cols">' +
              '<div class="footer-col"><h5>Studio</h5><a href="/studio#features">Features</a><a href="/studio#pricing">Pricing</a><a href="/studio#download">Get access</a></div>' +
